...
const TableFooter = React.forwardRef<
  ...
  React.HTMLAttributes<HTMLTableSectionElement>
>(({ className, ...props }, ref) => (
  <tfoot ref={ref} className={cx("bg-muted font-medium text-muted-foreground", className)} {...props} />
));
...
>(({ className, ...props }, ref) => (
  <tr ref={ref} className={cx("border-b transition-colors hover:bg-muted/50", className)} {...props} />
));
...
>(({ className, ...props }, ref) => (
  <td ref={ref} className={cx("p-2 align-middle [&:has([role=checkbox])]:pr-0", className)} {...props} />
));
